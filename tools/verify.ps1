...
$nodeTests = @(
  ...
  'js/game.test.js',
  'js/replay-contracts.test.js',
  'js/replay-event-queue.test.js',
  'js/replay-observer.test.js',
  'js/sealed-training.test.js',
  'tools/test_replay_consumer.mjs',
  'tools/test_sealed_training_converter.mjs',
  'tools/test_replay_e2e.mjs',
  'js/stats.test.js',
